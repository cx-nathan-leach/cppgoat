...
namespace cppgoat::DAL
{
  ...
  {
    public:
    virtual bool ValidateLogin(const std::string& email, const std::string& redacted)=0;
    virtual bool CreateUser(const std::string& email, const std::string& username, const std::string& redacted)=0;
